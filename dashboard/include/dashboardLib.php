...
class dashboardLib{
	public function printHeader($isSubdirectory = true){
		require_once __DIR__."/../../settings/name.php";
		...
		echo '<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
			...
			<link async rel="stylesheet" href="include/cvolton.css">
			<link async rel="stylesheet" href="include/font-awesome-4.7.0/css/font-awesome.min.css">
			<title>'. $gdpsname . ' Dashboard</title>
	...
	public function printNavbar($active){
		require_once __DIR__."/../../include/lib/mainLib.php";
		$gs = new mainLib();
		$homeActive = "";
		$accountActive = "";
		$modActive = "";
