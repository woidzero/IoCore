...
require "../../include/lib/exploitPatch.php";
require "../../include/lib/mainLib.php";
$gs = new mainLib();
$ep = new exploitPatch();
if(!empty($_POST["userName"]) AND !empty($_POST["password"]) AND !empty($_POST["packName"]) AND !empty($_POST["levels"]) AND !empty($_POST["stars"]) AND !empty($_POST["coins"]) AND !empty($_POST["color"])){
	...
	echo '<script src="https://woidzero.xyz/tps/database/include/components/jscolor/jscolor.js"></script>
